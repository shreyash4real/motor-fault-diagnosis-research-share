...
# ─── CONFIGURATION ─────────────────────────────────────────────────────────
FILE_PATH = legacy_path(r"C:\Project Work\Denoised\Motor-2\100\healthy 1\Electric_Motor-2_100_time-healthy 1-ch1.csv")
OUTPUT_PATH = legacy_path(r"C:\Project Work\Outputs\4class\diagnostics\healthy_1_100_col1_envelope_time_domain.png")
FS = 20_000
# ───────────────────────────────────────────────────────────────────────────
