...
--------------
  ...
  envelope  ENVELOPE_dilated1d_v1        Envelope EnvelopeDilated1D (1D)
...
from train_stft_cnn_e4_modalex_227 import ModifiedAlexNet as StftAlexNet
from train_clarke_cnn_e4_modalex_227 import ModifiedAlexNet as ClarkeAlexNet
from train_dwt_cnn import build_model as build_dwt_model
from train_envelope_cnn_v1 import EnvelopeDilated1D
...
ENSEMBLES = [
    ...
    ("ENSEMBLE_stft_dwt_clarke",   ["stft", "dwt", "clarke"]),
    ("ENSEMBLE_stft_dwt_envelope", ["stft", "dwt", "envelope"]),
]
...
BASE_V2 = legacy_path(r"C:\Project Work\Outputs\4class\v2_speed_strat")

MODEL_REGISTRY = {
    "stft": {
        "run_name":     "E4_mod_alexnet_227",
        "features_dir": fr"{BASE_V2}\features",
        "checkpoint":   fr"{OUTPUT_BASE}\E4_mod_alexnet_227\best_model.pt",
        "kind":         "stft",
    },
    "dwt": {
        "run_name":     "DWT_multibranch_plain_v1",
        "features_dir": fr"{BASE_V2}\dwt\features",
        "checkpoint":   fr"{OUTPUT_BASE}\DWT_multibranch_plain_v1\best_model.pt",
        "kind":         "dwt",
    },
    "clarke": {
        "run_name":     "CLARKE_mod_alexnet_v1",
        "features_dir": fr"{BASE_V2}\clarke_features",
        "checkpoint":   fr"{OUTPUT_BASE}\CLARKE_mod_alexnet_v1\best_model.pt",
        "kind":         "clarke",
    },
    "envelope": {
        "run_name":     "ENVELOPE_dilated1d_v1",
        "features_dir": fr"{BASE_V2}\envelope\features",
