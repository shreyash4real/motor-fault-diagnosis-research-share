"""
STEP 5 — STFT CNN TRAINING — STFTFreqNet v1
============================================
A lightweight, STFT-tailored CNN designed from the lessons of prior runs:
...
CHANNELS      = (16, 32, 48, 64, 96)
POOL_FREQ_OUT = 4       # AdaptiveAvgPool2d((POOL_FREQ_OUT, 1))
HEAD_HIDDEN   = 128
DROPOUT       = 0.3
