...
PROJECT_ROOT  = Path(legacy_path(r"C:\Project Work"))
TRAINING_ROOT = Path(legacy_path(r"C:\Project Work\Outputs\4class\training"))
SPLITS_CSV    = Path(legacy_path(r"C:\Project Work\Outputs\4class\v2_speed_strat\splits.csv"))
FEATURES_V2   = Path(legacy_path(r"C:\Project Work\Outputs\4class\v2_speed_strat"))
DENOISED_ROOT = PROJECT_ROOT / "Denoised" / "Motor-2"

DIAG_DIR = Path(legacy_path(r"C:\Project Work\Outputs\4class\diagnostics"))
