...
IMAGES_DIR     = r"C:\Project Work\outputs\4class\v2_speed_strat\envelope\images"
SAVE_PNGS      = True
# ──────────────────────────────────────────────────────────────────────────────
...
def main():
    ...
    FEATURES_DIR = path_value("MFDS_ENVELOPE_FEATURES_DIR", FEATURES_DIR)
    IMAGES_DIR = path_value("MFDS_ENVELOPE_IMAGES_DIR", IMAGES_DIR)
