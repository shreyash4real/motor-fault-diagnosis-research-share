"""
STEP 5 — ENVELOPE-SPECTRUM 1D RESNET TRAINING (v2 Refinement for nobpfo100)
===========================================================================
Refined iteration of train_envelope_cnn_v1.py, without the heavy v3 regularization.

CHANGES:
  1. Points to Outputs_nobpfo100 paths to test ablation of Envelope branch.
  2. Retains the v2 ResNet architecture (no heavy class weights, smoothing=0.05, dropout=0.4).

Usage
-----
    python train_envelope_cnn_v2_nobpfo100.py
"""
...
def main():
    ...
    summary = [f"Run: {RUN_NAME}", f"Params: {n_params:,}", f"Test Macro-F1: {te_f1:.4f}\n", "Per-Class F1:"]
