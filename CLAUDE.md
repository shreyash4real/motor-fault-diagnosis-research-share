...
**bpfo-3 ceiling broken.** `ENVELOPE_resnet_v3_reg` hits **0.823** solo bpfo-3 F1, exceeding the prior solo ceiling (0.793 from `E4_mod_alexnet_227`). The regularized envelope branch is now the strongest solo recourse for the bpfo-3@100% problem.
